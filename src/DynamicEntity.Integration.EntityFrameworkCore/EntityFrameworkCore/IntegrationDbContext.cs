...
public class IntegrationDbContext :
    AbpDbContext<IntegrationDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public DbSet<DynamicEntitey> dynamicEntiteys { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(IntegrationConsts.DbTablePrefix + "YourEntities", IntegrationConsts.DbSchema);
